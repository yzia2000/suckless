...
static const char *fonts[] = {
    "JetBrainsMono Nerd Font:antialias=true:autohint=true:size=5"};
...
static const char *termcmd[] = {
    "tabbed", "-r", "2", "st", "-w", "''", "-d", "\"$(cat $HOME/last_dir)\"",
    NULL};
static const char *rangercmd[] = {"st", "-e", "ranger", NULL};
static const char *browsercmd[] = {"firefox", NULL};
static const char *shutdowncmd[] = {"shutdown", "-h", "now", NULL};
static const char *hibernatecmd[] = {"systemctl", "hibernate", NULL};
static const char *upvol[] = {"/home/yushi/.config/suckless/dwm/scripts/volu",
                              NULL};
static const char *downvol[] = {"/home/yushi/.config/suckless/dwm/scripts/vold",
                                NULL};
static const char *mutemiccmd[] = {
    "/home/yushi/.config/suckless/dwm/scripts/togglemic", NULL};
